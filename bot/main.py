...
async def skywars(ctx, *player_and_mode):
    ...
    if len(player_and_mode) <= 1:
        ...
        if joinedmode == "solos normal":
            ...
            embed.add_field(name="K/D Rate:", value=getrate(data.get("kills_teams", 0) - data.get("kills_teams_insane", 0), data.get("deaths_teams", 0) - data.get("deaths_teams_insane", 0)), inline=True)
            ...
            embed.add_field(name="EXP:", value=data.get('skywars_experience', 0), inline=True)
            embed.add_field(name="Level:", value=getSkyWarsLevel(data.get("skywars_experience", 0)), inline=True)
            embed.add_field(name="Games Played:", value=data.get("wins_teams_insane", 0) + data.get("losses_teams_insane", 0), inline=True)
            embed.add_field(name="Kills:", value=data.get("kills_teams_insane", 0), inline=True)
            embed.add_field(name="Deaths:", value=data.get("deaths_teams_insane", 0), inline=True)
            embed.add_field(name="K/D Rate:", value=getrate(data.get("kills_teams_insane", 0), data.get("deaths_teams_insane", 0)), inline=True)
            embed.add_field(name="Wins:", value=data.get("wins_teams_insane", 0), inline=True)
            embed.add_field(name="Losses:", value=data.get("losses_teams_insane", 0), inline=True)
            embed.add_field(name="W/L Rate:", value=getrate(data.get("wins_teams_insane", 0), data.get("losses_teams_insane", 0)), inline=True)
        else:
